...
class ColorTheme:
    ...
    @staticmethod
    def STRToColoredSTR(s: str, pattern_color: dict[str, str]):
        func = {
        ...
        for pat, col in pattern_color.items():
            ...
            for match in matches:
                if not isinstance(match, str):
                    match = match[0]
                s = s.replace(match, func.get(
                    col.lower(), ColorTheme.cyan)(match))
        return s
...
if __name__ == '__main__':
    ...
    result = ColorTheme.STRToColoredSTR(
        input, {IPV4: "red", IPV6: "blue", MAC: "black"})
    print(result)
    ...
    text = text_green + text_red + text_blue + text_yellow + \
        text_purple + text_cyan + text_black + text_white
